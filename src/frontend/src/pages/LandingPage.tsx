  ...
  return (
    <section id="problem" className="bg-lavender py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          Millions of students silently struggle. The system wasn't built for
          you. MindEase was.
        </motion.p>
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            Take the first step. It's free, anonymous, and waiting for you right
            now.
          </p>
          <Link
            to="/app"
